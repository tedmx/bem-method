...
* [Why name of the modifier block is not written in the element name?](#Why-name-of-the-modifier-block-is-not-written-in-the-element-name)
...
## Why name of the modifier block is not written in the element name?
