...
* [Чому не можна писати ім'я модифікатора блоку в імені елемента?](#Чому-не-можна-писати-імя-модифікатора-блоку-в-імені-елемента)
...
## Чому не можна писати ім'я модифікатора блоку в імені елемента?
